...
: >"$BRAVE_CREDENTIAL"
: >"$GITHUB_CREDENTIAL"
chmod 600 "$ANTHROPIC_CREDENTIAL" "$BRAVE_CREDENTIAL" "$GITHUB_CREDENTIAL"
...
env \
	...
	DATABASE_URL="postgres://$DATABASE_USER@127.0.0.1:$POSTGRES_PORT/signalbox_native_real?password=&sslmode=verify-full&sslrootcert=$TLS_ROOT_CERTIFICATE" \
