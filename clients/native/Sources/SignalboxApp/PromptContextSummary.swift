...
private extension Dictionary where Key == String, Value == SignalboxJSONValue {
    func object(forKey key: String) -> [String: SignalboxJSONValue]? {
