...
enum MockSignalboxFixtures {
    ...
    [
      ...
      {"event_id":2,"event":{"kind":"message","message":{"role":"assistant","parts":[{"kind":"function_call","name":"bash","arguments":"{\\\"cmd\\\":\\\"bazel test //projects/signalbox/...\\\"}","call_id":"call-bash-1"}]},"visible_to_llm":true,"visible_to_user":true,"is_streaming":false,"parent_tool_invocation":null,"created_at":"2026-05-10T12:02:30Z","last_modified_at":"2026-05-10T12:02:30Z","created_from":"runner:local-runner"}},
    ...
    static let markdownBasicsEvents = messageEventsJSON(
        ...
        The **local server** is connected, the _native client_ is rendering Markdown, and `runner-docker` is available.
    ...
    static let markdownCodeEvents = messageEventsJSON(
        ...
        ```swift
        let status = SignalboxSessionStatus.State.waitingForConfirmation
        ```
    ...
    static let markdownEvents = messageEventsJSON(
        ...
        - Inspect [verification report](https://example.invalid/signalbox-native/report).
    ...
    private static func sessionJSON(
        ...
        return """
        {
          ...
          "linked_workspace_path": "/tmp/signalbox-native",
          "created_at": "2026-05-10T12:00:00Z",
