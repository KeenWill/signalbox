        ...
        NavigationStack {
            ...
            .overlay {
                if coordinator.service == nil {
                    ...
                    EmptyStateView(systemImage: "server.rack", title: "No runners", message: "Runners appear after registering with the server.")
                }
            }
        }
        ...
        NavigationStack {
            List(viewModel.templates) { template in
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    LabeledContent("Model", value: template.defaultModelAlias ?? "Server default")
...
private struct TemplateDerivativeStatusBadge: View {
    let status: SignalboxTemplateDerivativeStatus
...
private extension SignalboxTemplateDerivativeStatus {
...
private struct MonitorSummaryCard: View {
    let summary: SignalboxMonitorSessionSummary
