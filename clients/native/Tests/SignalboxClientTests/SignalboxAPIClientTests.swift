...
final class SignalboxAPIClientTests: XCTestCase {
    func testConfigurationRejectsInvalidURL() {
        XCTAssertThrowsError(
            try SignalboxClientConfiguration(baseURL: URL(string: "ftp://localhost")!, apiKey: "secret")
        )
    }
    ...
    func testCreateSessionEncodesLinkedWorkspacePath() async throws {
        ...
        let created = try await client.createSession(
            request: SignalboxCreateSessionRequest(
                templateID: SignalboxTemplateID(rawValue: "coder"),
                systemPrompt: nil,
                title: "Signalbox work",
                modelAlias: nil,
                enabledTools: nil,
                runnerID: SignalboxRunnerID(rawValue: "runner-1"),
        ...
        XCTAssertEqual(body["title"] as? String, "Signalbox work")
        XCTAssertEqual(body["runner_id"] as? String, "runner-1")
        XCTAssertEqual(body["linked_workspace_path"] as? String, "projects/signalbox")
    ...
    func testListEventsFollowsNextAfterCursor() async throws {
        let transport = MockSignalboxHTTPTransport()
        let sessionID = SignalboxSessionID(rawValue: "11111111-1111-4111-8111-111111111111")
        await transport.setJSONResponse(
    ...
    func testGetArtifactFetchesArtifactByID() async throws {
        let transport = MockSignalboxHTTPTransport()
        let sessionID = SignalboxSessionID(rawValue: "11111111-1111-4111-8111-111111111111")
        let artifactID = SignalboxArtifactID(rawValue: "22222222-2222-4222-8222-222222222222")
        await transport.setJSONResponse(
    ...
    func testArtifactDetailRoutesDispatchThroughProtocolExistential() async throws {
        ...
        let client: any SignalboxClientProtocol = SignalboxAPIClient(configuration: configuration, transport: transport)
    ...
    private static func artifactJSON(
        ...
        artifactID: SignalboxArtifactID = SignalboxArtifactID(rawValue: "22222222-2222-4222-8222-222222222222"),
        kind: String = "report"
    ) -> String {
        """
        {
