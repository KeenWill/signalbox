...
| S11 | High     | Added members on known version-one frames, messages, nested states, errors, or details invalidate the closed wire shape and therefore erase the known projection.                                                                                                                                                                                                                                                                                                                                                                                                                                            | **staged** — changing that rule requires an owner-approved revision to the [process protocol](../../../docs/spec/process-protocol.md). |
