const labels = new Map<string, string>(
  Object.entries({
    ...
    awaiting_credential_availability: 'Waiting for provider availability',
    network_unavailable: 'Network unavailable',
    contended: 'Provider capacity in use',
    exhausted: 'No provider currently available',
    ...
    awaiting_tool_approval: 'Tool approval required',
    ...
    child_lifecycle_disposition: 'Child outcome',
    ...
    claude_code_session_jsonl_v3: 'Claude Code, converter 3',
    code: 'Code',
    codex_rollout_jsonl_v1: 'Codex rollout, converter 1',
    codex_rollout_jsonl_v2: 'Codex rollout, converter 2',
    command_settled: 'Command outcome recorded',
    ...
    delegation_wake: 'Delegation wake',
    deny: 'Deny',
    derivative: 'Derived image',
    ...
    external_effect: 'External effects possible',
    failed: 'Failed',
    failed_retryable: 'Retryable failure',
    failed_structural: 'Structural failure',
    failed_unknown: 'Failure cause unknown',
    ...
    injection_settled: 'Message inserted',
    ...
    parent_cancelled_with_descendants: 'Parent cancellation; descendant policies apply',
    parent_stopped_with_descendants: 'Parent stop; descendant policies apply',
    parked: 'Parked',
    ...
    preview: 'Preview',
    proposed: 'Proposed',
    provide_goal_need: 'Input required',
    ...
    runner_lost_before_pin: 'Runner lost before assignment',
    ...
    source_message_block: 'Source message block',
    steering_input: 'Steering message',
    stop: 'Stop',
    stopped: 'Stopped',
    superseded: 'Superseded',
    suspect: 'Connection uncertain',
    target_not_found: 'Model or resource not found',
    terminal: 'Finished',
    ...
    turn_transcript_entry: 'Turn transcript entry',
    ultra: 'Ultra',
