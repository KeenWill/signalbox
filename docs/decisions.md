...
payload. Version seven stays reserved for the open owner turn-reconciliation
stack and unadmitted until it lands. The tool-loop repository's replay-payload
mismatch became the typed `ConflictingCommandReuse` error so the wire reports
