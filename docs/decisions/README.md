...
| [ADR-0046](0046-durable-command-telemetry-correlation.md)   | Stable non-reversible durable-command telemetry tokens, deployment-owned versioned key epochs, explicit rotation behavior, and fail-closed redaction                                                                                                                                                                                                                                                                   |
| [ADR-0047](0047-typed-model-runtime-substrate.md)           | Provider-neutral typed model-runtime substrate boundary, caller-owned durable correlation, single-send integration rules, and deferred application-facing SDK                                                                                                                                                                                                                                                          |
