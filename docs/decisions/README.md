...
| [ADR-0046](0046-durable-command-telemetry-correlation.md)   | Versioned, domain-separated HMAC correlation tokens for caller-supplied durable-command identifiers, with deployment-owned key epochs, restart stability, explicit rotation boundaries, and fail-closed telemetry redaction                                                                                                                                                                                            |
