...
stays staged and resumable while the call's tool rounds complete on the current
placement, then takes over at the placement boundary. The command claims its
identity and provisioning authorization immediately, and its terminal
