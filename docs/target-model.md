...
commit-order and durable-delivery storage foundation is implemented; append and
publisher slices remain pending.
...
| Transactional outbox publication                                           | Partially implemented — [ADR-0040](decisions/0040-transactional-outbox.md); commit-order and durable-delivery storage foundation only                                                                                                                                 |
