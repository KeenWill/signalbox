...
## EvaluationCorpusSourceStorageKind
...
impl<T> from_ref::FromRef<T> for mapping::EvaluationCorpusSourceStorageKind
where
    T: clone::Clone,
{
    fn from_ref(input: &T) -> T;
}
impl<T> dyn_clone::DynClone for mapping::EvaluationCorpusSourceStorageKind
where
    T: clone::Clone,
{
    fn __clone_box(&self, _: sealed::Private) -> *mut ();
}
impl<T> into_either::IntoEither for mapping::EvaluationCorpusSourceStorageKind {}
impl<T> parse_display::IntoResult<T> for mapping::EvaluationCorpusSourceStorageKind {
    type Err = never;
    fn into_result(self) -> result::Result<T, <T as parse_display::IntoResult<T>>::Err>;
}
impl<V, T> types::VZip<V> for mapping::EvaluationCorpusSourceStorageKind
where
    V: types::MultiLane<T>,
{
    fn vzip(self) -> V;
}
impl<T> request::IntoRequest<T> for mapping::EvaluationCorpusSourceStorageKind {
    fn into_request(self) -> request::Request<T>;
}
impl<L> layered::LayerExt<L> for mapping::EvaluationCorpusSourceStorageKind {
    fn named_layer<S>(
        &self,
        service: S,
...
impl<ST, DT> invariant::CastableFrom<ST, invariant::Uninit, invariant::Uninit>
    for mapping::EvaluationCorpusSourceStorageKind
where
    ST: ?marker::Sized,
    DT: ?marker::Sized,
{
...
pub const fn evaluation_corpus_source_to_str(
    value: mapping::EvaluationCorpusSourceStorageKind,
) -> &'static str;
```

## evaluation_corpus_source_from_str

```rust
pub fn evaluation_corpus_source_from_str(
    value: &str,
) -> option::Option<mapping::EvaluationCorpusSourceStorageKind>;
```
