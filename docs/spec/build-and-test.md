...
compilation is cacheable; database tests always execute. Daemon PostgreSQL
...
conformance tests use native Bazel targets; process-isolation tests retain their
provisioned Cargo job.
