...
lifecycle-cutoff phase and rule-or-obligation dispatch phase settles at most 16
durable records before returning to the webhook-aware scheduler. Reaching that
