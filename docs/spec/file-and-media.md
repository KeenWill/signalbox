...
| ---------------------- | ------------------------------------------------------------------------------ | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Archives / compression | `application/zip`, `application/x-tar`, `application/gzip`, `application/zstd` | `entries` | `zip` 8, `tar` 0.4, `flate2` 1 with `zlib-rs`, and `zstd` 0.13, compiled only into `signalbox-file-media-archives-worker`; extraction, execution, link following, special TAR entries, recursive containers, password input, and interpretation of decompressed payloads are excluded |
