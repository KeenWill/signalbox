...
| Video                  | `video/mp4`, `video/webm`                                                                                                                                                                                                   | Structural ISO BMFF and EBML detection over a bounded 4 KiB prefix; in-worker container parse confined to a 256 KiB metadata prefix                                                                                                                                                                                                                            | Bounded track count, duration, and codec profile as `metadata`                        | In-worker ISO BMFF and EBML parsing with no codec library; frame/audio decoding, rendering, frame extraction, thumbnails, OCR, transcription, subtitles, external resources, recursive containers, and metadata outside that prefix are excluded                                                                                                                                                                                                 |
