...
extension through PR #265 (`agent/tool-batch-tier0`), and the Tier 1 code-host
catalog extension through PR #270 (`agent/tool-batch-tier1`). Runner-protocol
batch reconstitution is verified through PR #260
