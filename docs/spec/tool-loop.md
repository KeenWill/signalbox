...
across overlapping parent edits, including equal parent outputs. Conflicting raw
JSON fixture-literal hunks in Rust test paths may also be regenerated; other
test code remains subject to the line check. A missing base effect or a changed
