...
(`agent/runner-protocol-domain`). Template-derived blanket creation was verified through PR #313
(`agent/session-templates`). It owns logical tool requests, approval
