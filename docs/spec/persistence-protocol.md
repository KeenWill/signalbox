...
- Migration `202608080105` gives every new durable connection-loss epoch a
  ...
  cursor. **Committed unimplemented functionality.** No present daemon service
  pages the durable losses, invokes these operations, or retires an
  unacknowledged workspace release; those orchestration steps remain outside the
  persistence adapter.
