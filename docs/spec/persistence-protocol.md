...
through PR #288 (`agent/audit-fix-docs-coherence`). The terminal model-call
token evidence columns and transcript reader were verified through PR #301
(`agent/token-usage`). This page covers the Postgres representation in
