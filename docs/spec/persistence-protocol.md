...
PR #384 (`agent/goal-mode-runtime`). This page covers the Postgres representation in
...
exception through PR #384 (`agent/goal-mode-runtime`). Why: database-level invariants
