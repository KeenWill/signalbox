...
(`agent/continuation-reconstitution`); the version-thirteen delivery surface,
queued restart behavior, and protocol-driven continuation steering were verified
against `agent/mid-turn-steering`. Code homes:
