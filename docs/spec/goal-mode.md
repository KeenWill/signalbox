...
The session lock covers reading and evaluating the finish condition through
committing its result. An achievement is gated on the session's finish check: a
