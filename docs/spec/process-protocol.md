...
| `resume_session`                        | `command_id` and `session_id` (canonical UUID strings)                                                                                                                                                                                                                                                                                                          | Return a parked goal-less session, or a module-parked session with a pursuing goal, to the state its suspended turn maps to.                                                                                                                                                                                                                                                    |
