...
| `adopt_session`                         | `command_id` and `session_id` (canonical UUID strings), `finish_condition` (string or null)                                                                                                                                                                                                                                                                     | Take the liveness obligation, declaring the finish condition when the session carries none.                                                                                                                                                                                                                                                                                     |
