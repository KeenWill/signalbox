...
[static model capability catalog](configuration-and-credentials.md#planned). The
exact settings vocabulary and the prohibition on exposing an alternate fast
