...
after it before waiting for future events. Events committed while the
predecessor handles its wake are therefore included in durable order, while the
consumed event itself cannot be delivered twice.
