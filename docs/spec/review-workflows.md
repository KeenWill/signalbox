...
clean base forwards; comment-only changes require a fresh quiet review. The Python
reconciler delegates evidence evaluation to the crate's CLI and retains its loop,
dispatch fence, and cool-off state.
