...
acknowledge the batch. Thinking-only attempts may change message identity before
the first text block. Its content is discarded; the reported finish must be
