...
leaves across fields and facts, decodes complete embedded JSON, and reconstructs
text, thinking, and JSON-escaped argument streams by kind and part index within
one request. A match increments
