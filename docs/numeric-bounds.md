...
its two consumers need different ceilings. The 136 rows partition as 35 guards,
8 derived bounds, 80 configuration policies, 9 representation facts, and 4 test
