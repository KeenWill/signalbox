...
its two consumers need different ceilings. The 115 rows partition as 34 guards,
8 derived bounds, 59 configuration policies, 10 representation facts, and 4 test
