...
use signalbox_process_protocol::{
    ...
    ModelSelection, ProtocolVersion, RejectionDetail, RequestId, ReviewConcernTerminalOutcome,
...
mod tests {
    ...
    use signalbox_process_protocol::{
        ...
        ConversationSummary, DescendantTerminationScope, FrameEncodeError, GoalCommandRejection,
