use super::{
    Body, Bytes, CONTENT_TYPE, DeserializeOwned, Error, HeaderValue, MAX_JSON_BODY_BYTES,
    MAX_NDJSON_ITEM_BYTES, Method, NDJSON_CONTENT_TYPE, Next, Request, Response, Serialize,
    StatusCode, Stream, StreamExt, TEXT_CONTENT_TYPE, has_content_type, has_json_content_type, io,
    to_bytes, transport_error, validate_supplied_origin,
};
...
pub(super) fn encode_ndjson_item<T>(item: T) -> Result<Bytes, io::Error>
where
    T: Serialize,
{
...
pub(super) struct NdjsonItemWriter {
