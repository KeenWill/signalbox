...
// numeric-bound: guard - prevents an unbounded caller-supplied filename from reaching a response
// header
const MAX_DISPLAY_FILENAME_BYTES: usize = 1024;
const BLOB_STREAM_CHUNK_BYTES: usize = 64 * 1024;
// numeric-bound: guard - prevents concurrent blob reads from exhausting process memory and store
// handles
