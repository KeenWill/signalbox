...
use signalbox_application::{
    ...
    TimelineModelCallDisposition, TimelineModelCallState, TimelineTextExcerpt, TimelineToolAttempt,
...
fn detail_body_dto(body: SessionTimelineDetailBody) -> WebSessionTimelineDetailBody {
    match body {
        ...
        SessionTimelineDetailBody::Delegation {
            ...
            reason,
            content,
        } => WebSessionTimelineDetailBody::Delegation {
            event_kind,
            relationship_id,
            subject_id,
            outcome,
...
mod tests {
    ...
    use signalbox_application::{
        ...
        TimelineBodyField, TimelineDetailCursor, max_attention_goal_summary_characters,
