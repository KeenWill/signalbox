...
use signalbox_process_protocol::{
    ...
    IMPORTED_CONVERSATION_INSPECTION_PROTOCOL_VERSION, IMPORTED_TRANSCRIPT_PROTOCOL_VERSION,
        ...
        Self {
            ...
            message: match code {
                ...
                ErrorCode::UnsupportedVersion => {
                    "the protocol version is unsupported; supported versions: 1 through 11 and 15"
                }
