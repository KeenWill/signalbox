...
pub(super) fn wire_operator_status_held_slot_origin(
...
pub(super) fn wire_operator_status_singleton_scope(
...
pub(super) fn wire_operator_status_blocker(
...
pub(super) fn wire_operator_status_mergeable_state(
...
pub(super) fn wire_operator_status_review_decision(
...
pub(super) fn wire_operator_status_verdict(
...
pub(super) fn wire_operator_status_seal(
