...
use signalbox_domain::{
    ...
    FastModeSupport, FrozenAliasDefinition, InstructionPath, ModelAlias, ModelCapabilities,
    ...
    ProviderModelIdentity, ReasoningLevel, ResolvedProviderTarget, ServiceTier, SettingOverlay,
...
"#,
    ...
    #[test]
    fn configuration_rejects_the_removed_repository_watch_section() {
        let configured = format!("{CONFIGURATION}\n[repository_watch]\nversion = 1\n");
