...
def fixture_cases_by_specification() -> dict[str, list]:
    ...
    return {
        ...
        RUST_CANDIDATE_SELECTION: list(CANDIDATE_CASES),
        NATIVE_CANDIDATE_SELECTION: list(CANDIDATE_CASES),
        RUST_ARTIFACT_LOOKUP: list(ARTIFACT_CASES),
        NATIVE_ARTIFACT_LOOKUP: list(ARTIFACT_CASES),
        NATIVE_STEP_CONCLUSION: list(STEP_CONCLUSION_CASES),
    }
