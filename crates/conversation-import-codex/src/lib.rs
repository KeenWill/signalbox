...
mod tests {
    ...
    #[test]
    fn normalizes_complete_rollout_vocabulary() {
    ...
    #[test]
    fn event_mirror_and_developer_message_remain_source_events() {
        let imported = convert_synthetic(
    ...
    #[test]
    fn preserves_typed_absence_without_placeholders() {
        let imported = convert_synthetic(
    ...
    #[test]
    fn rejects_duplicate_consulted_members_content_silently() {
    ...
    #[test]
    fn rejects_non_string_named_tool_inputs() {
        for source in [
