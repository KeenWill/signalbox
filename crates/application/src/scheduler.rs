...
impl InProcessEligibilityNudge {
    /// Retains a committed hint until channel capacity becomes available or the work source closes.
    pub async fn nudge_when_ready(&self, session: SessionId) -> EligibilityNudgeOutcome {
