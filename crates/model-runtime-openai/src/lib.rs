//! OpenAI Responses adapter for the Layer-1 model runtime specified
...
//! then consumes that capability as at most one `POST /v1/responses`
...
//! public Responses API documentation.
//!
...
//! # Stream integrity
//!
//! The Responses stream terminates with a terminal response event. A
