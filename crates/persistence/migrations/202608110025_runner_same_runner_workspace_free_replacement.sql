-- Admit the registration-loss-only same-runner arm of the workspace-free
-- pinned replacement result. Ordinary replacement remains different-runner.

-- Supersede the applied 202608110022 result shape without editing it.
