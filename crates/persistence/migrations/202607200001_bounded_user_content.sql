...
-- The domain rejects oversized text before construction; these checks make
-- the durable representation refuse content the domain could no longer read
-- back. Existing rows satisfy the bound trivially.
