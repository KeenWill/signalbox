...
-> Result<(), Box<dyn Error>> {
    ...
    expect![[r#"
        ...
        │ value                                                                                                                                                                                                                                                                                             │
        ├───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤
        │ NestedCascadeEdgeFacts { spawning_tool_request_id: 00000000-0000-0000-0000-00000000f610, parent_session_id: 00000000-0000-0000-0000-00000000f600, termination_kind: "stopped", source_kind: "root", source_spawning_tool_request_id: None }                                                       │
        │ NestedCascadeEdgeFacts { spawning_tool_request_id: 00000000-0000-0000-0000-00000000f620, parent_session_id: 00000000-0000-0000-0000-00000000f601, termination_kind: "cancelled", source_kind: "parent_disposition", source_spawning_tool_request_id: Some(00000000-0000-0000-0000-00000000f610) } │
        └───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
    "#]]
    ...
    expect![[r#"
        ...
        │ value                                                                                                                                                                               │
        ├─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤
        │ NestedCascadeOutcomeFacts { spawning_tool_request_id: 00000000-0000-0000-0000-00000000f610, outcome_kind: "child_cancelled", reason_kind: "parent_stopped_parent_and_descendants" } │
        │ NestedCascadeOutcomeFacts { spawning_tool_request_id: 00000000-0000-0000-0000-00000000f620, outcome_kind: "child_stopped", reason_kind: "parent_cancelled_parent_and_descendants" } │
        └─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
    "#]]
...
-> Result<(), Box<dyn Error>> {
    ...
    expect![[r#"
        ...
        │ value                                                                                                                                                                                                                                       │
        ├─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤
        │ NestedCascadeEdgeFacts { spawning_tool_request_id: 00000000-0000-0000-0000-00000000f710, parent_session_id: 00000000-0000-0000-0000-00000000f700, termination_kind: "stopped", source_kind: "root", source_spawning_tool_request_id: None } │
        └─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
    "#]]
    .assert_eq(&table(edges));
