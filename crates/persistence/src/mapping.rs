...
use signalbox_domain::{
    ...
    GoalUserAction, SessionConfigurationDefaultsVersion, SessionCreationCause, SessionId,
    SessionInputPosition, SessionPlacementEventKind, ToolApprovalPosture, ToolAttemptId,
...
mod tests {
    ...
    use super::{
        ...
        plan_event_kind_to_str, session_creation_cause_from_str, session_creation_cause_to_str,
