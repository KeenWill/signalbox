...
use signalbox_domain::{
    ...
    SessionConfigurationDefaultsVersion, SessionId, SessionInputPosition, ToolApprovalPosture,
...
mod tests {
    ...
    use signalbox_domain::{
        ...
        SessionInputPosition, ToolApprovalPosture, ToolPermissionDefault, TurnId,
    };
    use sqlx::types::Uuid;
