...
use signalbox_domain::{
    ...
    FrozenModelSelection, ImportedConversationId, ImportedSourceAttestation,
...
fn decode_transcript_turn(row: &PgRow) -> Result<DecodedTurn, ProcessReadError> {
    ...
    let model_settings = decode_transcript_turn_model_settings(row, turn, origin_accepted_input)?;
