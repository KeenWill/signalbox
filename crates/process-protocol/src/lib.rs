...
pub enum ProtocolVersion {
    ...
    Nine,
    /// Reserved directory-import vocabulary.
    Ten,
...
impl ProtocolVersion {
    ...
    pub const fn as_u64(self) -> u64 {
        match self {
            ...
            Self::Ten => DIRECTORY_IMPORT_PROTOCOL_VERSION,
    ...
    const fn from_u64(value: u64) -> Option<Self> {
        match value {
            ...
            DIRECTORY_IMPORT_PROTOCOL_VERSION => Some(Self::Ten),
    ...
    fn fmt(&self, formatter: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self.kind {
            ...
            FrameDecodeErrorKind::UnsupportedVersion => formatter.write_str(
                "process-protocol version is unsupported; supported versions are 1 through 11",
            ),
        }
    }
}
...
mod tests {
    ...
    fn assert_unsupported_version(version: &str) {
        ...
        assert!(
            error
                .to_string()
                .contains("supported versions are 1 through 11")
        );
    }
