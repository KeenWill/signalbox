...
-> Result<(), Box<dyn std::error::Error>> {
    ...
    assert_server_message_round_trip(
        request(1)?,
        ServerMessage::OperatorStatus(Box::new(OperatorStatusMessage::LifecycleWeek(Box::new(
    ...
    assert_server_message_round_trip(
        request(1)?,
        ServerMessage::OperatorStatus(Box::new(OperatorStatusMessage::LifecycleDeadlineViolation(
            Box::new(OperatorStatusLifecycleDeadlineViolationMessage {
