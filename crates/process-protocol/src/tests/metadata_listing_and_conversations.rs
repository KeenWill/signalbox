...
#[test]
fn metadata_replacement_request_has_an_exact_closed_shape() -> Result<(), Box<dyn std::error::Error>>
{
    assert_client_request_round_trip(
        request(3)?,
...
#[test]
fn list_conversations_request_has_an_exact_closed_shape() -> Result<(), Box<dyn std::error::Error>>
{
...
#[test]
fn conversation_page_messages_have_exact_closed_shapes() -> Result<(), Box<dyn std::error::Error>> {
