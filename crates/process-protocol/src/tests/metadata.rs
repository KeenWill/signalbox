...
#[test]
fn metadata_capacity_matches_domain_and_frame_headroom() -> Result<(), Box<dyn std::error::Error>> {
...
#[test]
fn metadata_filter_capacity_is_enforced_before_mapping() -> Result<(), Box<dyn std::error::Error>> {
...
#[test]
fn metadata_summary_rejects_unwritten_nondefault_content() -> Result<(), Box<dyn std::error::Error>>
{
    assert_metadata_message_rejected(ServerMessage::SessionMetadataSummary {
        session_id: uuid(1),
        defaults_version: CanonicalU64::new(1),
...
#[test]
fn metadata_read_rejects_written_content_without_a_writer() -> Result<(), Box<dyn std::error::Error>>
{
