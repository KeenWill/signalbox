...
pub const MODEL_ALIAS: &str = "claude-synthetic-alias";
pub const MODEL_RESOLVED: &str = "claude-synthetic-alias-20260809";
pub const OTHER_MODEL: &str = "claude-other-model";
