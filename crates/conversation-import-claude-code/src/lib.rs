...
mod tests {
    ...
    #[test]
    fn crlf_delimiter_is_not_raw_record_content() {
        let imported =
    ...
    #[test]
    fn each_entry_boundary_resolves_its_exact_prefix() {
    ...
    #[test]
    fn within_record_positions_follow_exact_sequence() {
        let imported = convert_synthetic(
            "{\"type\":\"user\",\"message\":{\"content\":[\
             {\"type\":\"text\",\"text\":\"one\"},\
             {\"type\":\"text\",\"text\":\"two\"}]}}\n\
    ...
    #[test]
    fn maps_non_message_records_to_source_events() {
    ...
    #[test]
    fn attests_message_speaker_from_top_level_type() {
    ...
    #[test]
    fn preserves_absent_text_inside_tool_result_blocks() {
        let imported = convert_synthetic(
            "{\"type\":\"user\",\"message\":{\"content\":[\
    ...
    #[test]
    fn maps_source_defined_tool_result_blocks_without_dropping_the_result() {
        let imported = convert_synthetic(
            "{\"type\":\"user\",\"message\":{\"content\":[\
    ...
    #[test]
    fn null_typed_result_block_retains_explicit_absence() {
        let imported = convert_synthetic(
            "{\"type\":\"user\",\"message\":{\"content\":[\
    ...
    #[test]
    fn untyped_source_message_block_retains_typed_absence() {
        let imported = convert_synthetic(
    ...
    #[test]
    fn maps_tool_call_fields_together() {
        let imported = convert_synthetic(
            "{\"type\":\"assistant\",\"message\":{\"content\":[\
    ...
    #[test]
    fn maps_thinking_and_signature_together() {
        let imported = convert_synthetic(
            "{\"type\":\"assistant\",\"message\":{\"content\":[\
    ...
    #[test]
    fn maps_redacted_thinking_data() {
        let imported = convert_synthetic(
            "{\"type\":\"assistant\",\"message\":{\"content\":[\
    ...
    #[test]
    fn maps_document_media_source_fields_together() {
        let imported = convert_synthetic(
            "{\"type\":\"assistant\",\"message\":{\"content\":[\
    ...
    #[test]
    fn preserves_empty_and_absent_text_attestations() {
        let source = concat!(
            "{\"type\":\"user\",\"message\":{\"content\":[",
    ...
    #[test]
    fn conversion_error_rendering_is_content_silent() {
        let source = concat!(
            "{\"type\":\"user\",\"message\":{\"content\":\"secret-before\"}}\n",
            "{\"type\":\"assistant\",\"message\":{\"content\":[",
    ...
    #[test]
    fn preserves_terminal_lone_carriage_return_as_raw_content() {
    ...
    #[test]
    fn terminal_lf_does_not_create_an_empty_record() {
        let imported = ClaudeCodeJsonlConverter
    ...
    #[test]
    fn rejects_utf8_bom_at_record_start() {
        let error = ClaudeCodeJsonlConverter
    ...
    #[test]
    fn rejects_duplicate_modeled_members() {
        let error = ClaudeCodeJsonlConverter
            .convert(
                conversation(),
    ...
    #[test]
    fn rejects_message_role_conflicts() {
        let error = ClaudeCodeJsonlConverter
            .convert(
                conversation(),
    ...
    #[test]
    fn resilient_conversion_reports_every_distinct_skipped_record() {
    ...
    #[test]
    fn strict_conversion_preserves_blank_line_error_precedence() {
        let error = ClaudeCodeJsonlConverter
